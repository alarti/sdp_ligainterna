...
<div id="primary" class="site-content">
        <div id="content" role="main">
            ...
            <br>
            <fieldset style="width: 70%;margin-left: 10%;margin-right: 10%" ><legend><strong>Resultado de partidos</strong></legend>
             <form method="post" name="clasificacion">
                 <br>
                    <div  width="50%">
...
<p><input name="resultados" type="button" value="Mostrar resultados"/></p>
 </div>
             </form>
            </fieldset>
    </div>

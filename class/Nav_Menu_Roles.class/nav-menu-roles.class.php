...
class Nav_Menu_Roles {
    ...
    function admin_init() {
      ...
      include_once( plugin_dir_path( __FILE__ ) . 'Nav_Menu_Edit_Roles.php');
    ...
    function register_importer(){
      ...
      include_once( plugin_dir_path( __FILE__ ) . 'Nav_Menu_Roles_Import.php');
     ...
     * is be passed to Nav_Menu_Edit_Custom
     * @since 1.0
     */
